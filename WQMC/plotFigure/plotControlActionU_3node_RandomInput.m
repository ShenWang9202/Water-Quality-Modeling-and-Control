function plotControlActionU_3node_RandomInput(ControlActionU,BoosterLocationIndex,Location_B)
figure1 = figure
h1 = subplot(1,2,1)
fontsize = 38;
...
ylabel({'Mass rate (mg/min)'},'FontSize',fontsize,'interpreter','latex')
%% plot enlarged part
h2 = subplot(1,2,2)
InterestedTime1 = 1;
InterestedTime2 = 20;
