function plotMinMaxRange4Junction_WQM(y,InterestedID,IDLibrary,faceColor,tranparecy,fontSize,BlueLineWidth,lineWidth,InterestedTime1,InterestedTime2,FileName,TitleName)
...
xticklabels({num2str(InterestedTime1),num2str(InterestedTime2)})
